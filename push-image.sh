...
if [ "$TOKEN" != "null" ]; then
    ...
    if [ "$RELEASE" == "TEST" ]; then
        ...
        echo "Push Image -> ${DOCKER_IMAGE}:${ALPINE_VERSION}-${MAXMIND_GEOLITE_VERSION}-${ALPINE_ARCHITECTURE}"
        docker push ${DOCKER_IMAGE}:${ALPINE_VERSION}-${MAXMIND_GEOLITE_VERSION}-${ALPINE_ARCHITECTURE}
        ...
        echo "Push Image -> ${DOCKER_IMAGE}:${MAXMIND_GEOLITE_VERSION}-${ALPINE_ARCHITECTURE}"
        docker push ${DOCKER_IMAGE}:${MAXMIND_GEOLITE_VERSION}-${ALPINE_ARCHITECTURE}
